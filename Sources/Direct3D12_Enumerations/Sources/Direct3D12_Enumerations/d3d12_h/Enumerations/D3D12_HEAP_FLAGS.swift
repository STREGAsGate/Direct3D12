...
public struct D3DHeapFlags: OptionSet {
    ...
    //static let none = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_NONE.rawValue)

    ///	The heap is shared. Refer to Shared Heaps.
    static let shared = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_SHARED.rawValue)
    ///	The heap isn't allowed to contain buffers.
    static let denyBuffers = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_DENY_BUFFERS.rawValue)
    ///	The heap is allowed to contain swap-chain surfaces.
    static let allowDisplay = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_ALLOW_DISPLAY.rawValue)
    ///	The heap is allowed to share resources across adapters. Refer to Shared Heaps.
    static let sharedAcrossAdapter = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_SHARED_CROSS_ADAPTER.rawValue)
    ///	The heap is not allowed to store Render Target (RT) and/or Depth-Stencil (DS) textures.
    static let denyRenderTargetAndDepthStencilTextures = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_DENY_RT_DS_TEXTURES.rawValue)
    ...
    static let denyNonRenderTargetAndDepthStencilTextures = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_DENY_NON_RT_DS_TEXTURES.rawValue)
    ///	Unsupported. Do not use.
    static let hardwareProtected = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_HARDWARE_PROTECTED.rawValue)
    ...
    static let allowWriteWatch = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_ALLOW_WRITE_WATCH.rawValue)
    /**	
    ...
    */
    static let allowShaderAtomics = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_ALLOW_SHADER_ATOMICS.rawValue)
    ...
    static let createNotResident = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_CREATE_NOT_RESIDENT.rawValue)
    ...
    static let createNotZeroed = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_CREATE_NOT_ZEROED.rawValue)
    ...
    static let allowAllBuffersAndTextures = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_ALLOW_ALL_BUFFERS_AND_TEXTURES.rawValue)
    ///	The heap is only allowed to store buffers. This is an alias; for more details, see "Aliases" in the Remarks section.
    static let allowOnlyBuffers = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_ALLOW_ONLY_BUFFERS.rawValue)
    ...
    static let allowOnlyNonRenderTargetOrDepthStencilTextures = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_ALLOW_ONLY_NON_RT_DS_TEXTURES.rawValue)
    ...
    static let allowOnlyRenderTargetAndDepthStencilTextures = D3DHeapFlags(rawValue: WinSDK.D3D12_HEAP_FLAG_ALLOW_ONLY_RT_DS_TEXTURES.rawValue)
