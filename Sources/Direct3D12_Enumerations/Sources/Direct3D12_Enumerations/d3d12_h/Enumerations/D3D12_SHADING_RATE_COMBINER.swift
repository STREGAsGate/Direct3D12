...
case sum
    ...
    internal var rawValue: WinSDK.D3D12_SHADING_RATE_COMBINER {
        switch self {
        case .passthrough:
            return WinSDK.D3D12_SHADING_RATE_COMBINER_PASSTHROUGH
        case .override:
            return WinSDK.D3D12_SHADING_RATE_COMBINER_OVERRIDE
        case .min:
            return WinSDK.D3D12_SHADING_RATE_COMBINER_MIN
        case .max:
            return WinSDK.D3D12_SHADING_RATE_COMBINER_MAX
        case .sum:
            return WinSDK.D3D12_SHADING_RATE_COMBINER_SUM
        }
    }
}
