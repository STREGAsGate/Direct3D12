...
public struct RaytracingInstanceFlags: OptionSet {
    ...
    //static let none = RaytracingInstanceFlags(rawValue: WinSDK.D3D12_RAYTRACING_INSTANCE_FLAG_NONE.rawValue)
    ...
    static let triangleCullDisable = RaytracingInstanceFlags(rawValue: WinSDK.D3D12_RAYTRACING_INSTANCE_FLAG_TRIANGLE_CULL_DISABLE.rawValue)
    ...
    static let triangleFrontCounterClockwise = RaytracingInstanceFlags(rawValue: WinSDK.D3D12_RAYTRACING_INSTANCE_FLAG_TRIANGLE_FRONT_COUNTERCLOCKWISE.rawValue)
    ...
    static let forceOpaque = RaytracingInstanceFlags(rawValue: WinSDK.D3D12_RAYTRACING_INSTANCE_FLAG_FORCE_OPAQUE.rawValue)
    ...
    static let forceNonOpaque = RaytracingInstanceFlags(rawValue: WinSDK.D3D12_RAYTRACING_INSTANCE_FLAG_FORCE_NON_OPAQUE.rawValue)
