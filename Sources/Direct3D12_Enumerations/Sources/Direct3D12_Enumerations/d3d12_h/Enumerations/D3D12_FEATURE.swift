...
public enum Feature {
    ///	Indicates a query for the level of support for basic Direct3D 12 feature options. The corresponding data structure for this value is D3D12_FEATURE_DATAWinSDK_OPTIONS.
    case options
    ...
    case shaderModel
    ///	Indicates a query for the level of support for HLSL 6.0 wave operations. The corresponding data structure for this value is D3D12_FEATURE_DATAWinSDK_OPTIONS1.
    case options1
    ...
    case architecture1
    ///	Indicates a query for the level of support for depth-bounds tests and programmable sample positions. The corresponding data structure for this value is D3D12_FEATURE_DATAWinSDK_OPTIONS2.
    case options2
    ...
    ///	Indicates a query for the level of support for timestamp queries, format-casting, immediate write, view instancing, and barycentrics. The corresponding data structure for this value is D3D12_FEATURE_DATAWinSDK_OPTIONS3.
    case options3
    ...
    case existingHeaps
    ///	Indicates a query for the level of support for 64KB-aligned MSAA textures, cross-API sharing, and native 16-bit shader operations. The corresponding data structure for this value is D3D12_FEATURE_DATAWinSDK_OPTIONS4.
    case options4
    ...
    case crossNode
    ///	Starting with Windows 10, version 1809 (10.0; Build 17763), indicates a query for the level of support for render passes, ray tracing, and shader-resource view tier 3 tiled resources. The corresponding data structure for this value is D3D12_FEATURE_DATAWinSDK_OPTIONS5.
    case options5
    ...
    internal var rawValue: WinSDK.D3D12_FEATURE {
        switch self {
        case .options:
...
public extension Feature  {
    ...
    static let D3D12_FEATUREWinSDK_OPTIONS = Self.options
    ...
    static let D3D12_FEATUREWinSDK_OPTIONS1 = Self.options1
    ...
    static let D3D12_FEATUREWinSDK_OPTIONS2 = Self.options2
    ...
    static let D3D12_FEATUREWinSDK_OPTIONS3 = Self.options3
    ...
    static let D3D12_FEATUREWinSDK_OPTIONS4 = Self.options4
    ...
    static let D3D12_FEATUREWinSDK_OPTIONS5 = Self.options5
    
    @available(*, deprecated, renamed: "options6")
    static let D3D12_FEATUREWinSDK_OPTIONS6 = Self.options6
    ...
    static let D3D12_FEATUREWinSDK_OPTIONS7 = Self.options7
