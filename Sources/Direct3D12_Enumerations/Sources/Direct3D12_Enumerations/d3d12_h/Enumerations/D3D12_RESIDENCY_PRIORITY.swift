...
public enum ResidencyPriority {
    ...
    internal var rawValue: WinSDK.D3D12_RESIDENCY_PRIORITY {
        ...
        case .low:
            return WinSDK.D3D12_RESIDENCY_PRIORITY_LOW
        case .normal:
            return WinSDK.D3D12_RESIDENCY_PRIORITY_NORMAL
        case .high:
            return WinSDK.D3D12_RESIDENCY_PRIORITY_HIGH
        case .maximum:
            return WinSDK.D3D12_RESIDENCY_PRIORITY_MAXIMUM
        }
    }
}
