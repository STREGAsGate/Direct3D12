...
public enum RaytracingAccelerationStructureCopyMode {
    ...
    */
    ...
    internal var rawValue: WinSDK.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE {
        switch self {
    case .clone:
        return WinSDK.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE_CLONE
    case .compact:
        return WinSDK.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE_COMPACT
    case .visualizationDecodeForTools:
        return WinSDK.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE_VISUALIZATION_DECODE_FOR_TOOLS
    case .serialize:
        return WinSDK.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE_SERIALIZE
    case .deserialize:
        return WinSDK.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE_DESERIALIZE
        }
    }
}
