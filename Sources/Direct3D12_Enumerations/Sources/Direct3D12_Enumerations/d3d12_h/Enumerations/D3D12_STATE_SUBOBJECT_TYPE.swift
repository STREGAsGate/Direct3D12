...
case maxValid
    ...
    internal var rawValue: WinSDK.D3D12_STATE_SUBOBJECT_TYPE {
        switch self {
        case .stateObjectConfig:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_STATE_OBJECT_CONFIG
        case .globalRootSignature:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_GLOBAL_ROOT_SIGNATURE
        case .localRootSignature:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_LOCAL_ROOT_SIGNATURE
        case .nodeMask:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_NODE_MASK
        case .dxilLibrary:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_DXIL_LIBRARY
        case .existingCollection:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_EXISTING_COLLECTION
        case .subobjectToExportsAssociation:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_SUBOBJECT_TO_EXPORTS_ASSOCIATION
        case .dxilSubobjectToExportsAssociation:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_DXIL_SUBOBJECT_TO_EXPORTS_ASSOCIATION
        case .raytracingShaderConfig:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_RAYTRACING_SHADER_CONFIG
        case .raytracingPipelineConfig:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_RAYTRACING_PIPELINE_CONFIG
        case .hitGroup:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_HIT_GROUP
        case .maxValid:
            return WinSDK.D3D12_STATE_SUBOBJECT_TYPE_MAX_VALID
        }
    }
}
