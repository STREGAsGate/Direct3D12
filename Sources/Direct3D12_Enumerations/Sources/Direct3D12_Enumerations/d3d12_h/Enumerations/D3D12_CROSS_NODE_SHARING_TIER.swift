...
public enum CrossNodeSharing {
    /// If an adapter has only 1 node, then cross-node sharing doesn't apply, so the CrossNodeSharingTier member of the [D3D12_FEATURE_DATAWinSDK_OPTIONS](https://docs.microsoft.com/en-us/windows/desktop/api/d3d12/ns-d3d12-d3d12_feature_dataWinSDK_options) structure is set to D3D12_CROSS_NODE_SHARING_NOT_SUPPORTED.
    case notSupported
    /// Tier 1 Emulated. Devices that set the CrossNodeSharingTier member of the [D3D12_FEATURE_DATAWinSDK_OPTIONS](https://docs.microsoft.com/en-us/windows/desktop/api/d3d12/ns-d3d12-d3d12_feature_dataWinSDK_options) structure to D3D12_CROSS_NODE_SHARING_TIER_1_EMULATED have Tier 1 support.
    ...
    case tier1Emulated
    /**
    Tier 1. Devices that set the CrossNodeSharingTier member of the [D3D12_FEATURE_DATAWinSDK_OPTIONS](https://docs.microsoft.com/en-us/windows/desktop/api/d3d12/ns-d3d12-d3d12_feature_dataWinSDK_options) structure to D3D12_CROSS_NODE_SHARING_TIER_1 only support the following cross-node copy operations:
    ...
    */
    ...
    /**
    Tier 2. Devices that set the CrossNodeSharingTier member of the [D3D12_FEATURE_DATAWinSDK_OPTIONS](https://docs.microsoft.com/en-us/windows/desktop/api/d3d12/ns-d3d12-d3d12_feature_dataWinSDK_options) structure to D3D12_CROSS_NODE_SHARING_TIER_2 support all operations across nodes, except for the following:
    ...
    */
    ...
    internal var rawValue: WinSDK.D3D12_CROSS_NODE_SHARING_TIER {
        switch self {
        case .notSupported:
            return WinSDK.D3D12_CROSS_NODE_SHARING_TIER_NOT_SUPPORTED
        case .tier1Emulated:
            return WinSDK.D3D12_CROSS_NODE_SHARING_TIER_1_EMULATED
        case .tier1:
            return WinSDK.D3D12_CROSS_NODE_SHARING_TIER_1
        case .tier2:
            return WinSDK.D3D12_CROSS_NODE_SHARING_TIER_2
        case .tier3:
            return WinSDK.D3D12_CROSS_NODE_SHARING_TIER_3
        }
    }
}
