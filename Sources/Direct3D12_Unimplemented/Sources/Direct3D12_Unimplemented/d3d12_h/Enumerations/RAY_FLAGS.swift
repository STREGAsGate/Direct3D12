...
public struct RayFlags: OptionSet {
    ...
    ///// No options selected.
    //public static let none = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_NONE.rawValue)
    ...
    public static let forceOpaque = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_FORCE_OPAQUE.rawValue)
    ...
    public static let forceNonOpaque = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_FORCE_NON_OPAQUE.rawValue)
    ...
    public static let acceptFirstHitAndEndSearch = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_ACCEPT_FIRST_HIT_AND_END_SEARCH.rawValue)
    ...
    public static let skipClosestHitShader = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_SKIP_CLOSEST_HIT_SHADER.rawValue)
    ...
    public static let cullBackFacingTriangles = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_CULL_BACK_FACING_TRIANGLES.rawValue)
    ...
    ///
    /// This flag is mutually exclusive with RAY_FLAG_CULL_FRONT_FACING_TRIANGLES.
    public static let cullFrontFacingTriangles = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_CULL_FRONT_FACING_TRIANGLES.rawValue)
    ...
    public static let cullOpaque = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_CULL_OPAQUE.rawValue)
    ...
    public static let cullNonOpaque = RayFlags(rawValue: WinSDK.D3D12_RAY_FLAG_CULL_NON_OPAQUE.rawValue)
