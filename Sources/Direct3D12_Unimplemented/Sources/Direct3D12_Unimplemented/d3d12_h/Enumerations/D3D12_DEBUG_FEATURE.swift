...
public struct DebugFeature: OptionSet {
    ...
    //public static let none = DebugFeature(rawValue: WinSDK.D3D12_DEBUG_FEATURE_NONE.rawValue)
    ...
    public static let allowBehaviorChangingDebugAids = DebugFeature(rawValue: WinSDK.D3D12_DEBUG_FEATURE_ALLOW_BEHAVIOR_CHANGING_DEBUG_AIDS.rawValue) 
    ...
    public static let conservativeResourceStateTracking = DebugFeature(rawValue: WinSDK.D3D12_DEBUG_FEATURE_CONSERVATIVE_RESOURCE_STATE_TRACKING.rawValue) 
    ///	Disables validation of bundle commands by virtually injecting checks into the calling command list validation paths.
    public static let disablesVirtualizedBundlesValidation = DebugFeature(rawValue: WinSDK.D3D12_DEBUG_FEATURE_DISABLE_VIRTUALIZED_BUNDLES_VALIDATION.rawValue) 
