...
public struct DescriptorHeapFlags: OptionSet {
    ...
    //static let none = DescriptorHeapFlags(rawValue: WinSDK.D3D12_DESCRIPTOR_HEAP_FLAG_NONE.rawValue)
    ...
    */
    static let shaderVisible = DebugFeature(rawValue: WinSDK.D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE.rawValue) 
