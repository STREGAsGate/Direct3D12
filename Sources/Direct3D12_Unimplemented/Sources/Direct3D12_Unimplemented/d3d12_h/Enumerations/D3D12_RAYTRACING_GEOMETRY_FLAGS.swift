...
public struct RaytracingGeometryFlags: OptionSet {
    ...
    //static let none = RaytracingGeometryFlags(rawValue: WinSDK.D3D12_RAYTRACING_GEOMETRY_FLAG_NONE.rawValue)
    ...
    static let opaque = RaytracingGeometryFlags(rawValue: WinSDK.D3D12_RAYTRACING_GEOMETRY_FLAG_OPAQUE.rawValue)
    ...
    static let noDuplicateAnyHitInvocation = RaytracingGeometryFlags(rawValue: WinSDK.D3D12_RAYTRACING_GEOMETRY_FLAG_NO_DUPLICATE_ANYHIT_INVOCATION.rawValue)
