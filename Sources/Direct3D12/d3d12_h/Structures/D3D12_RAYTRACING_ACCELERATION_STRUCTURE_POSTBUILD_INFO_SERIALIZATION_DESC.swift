...
public struct RaytracingAccelerationStructurePostbuildInfoSerializationDescription {
    internal var rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_SERIALIZATION_DESC


    internal init(_ rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_SERIALIZATION_DESC) {
