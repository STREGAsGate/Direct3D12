...
public enum MemoryPool {
    ...
    internal var rawValue: _d3d12.D3D12_MEMORY_POOL {
        switch self {
    case .unknow:
        return _d3d12.D3D12_MEMORY_POOL_UNKNOWN
    case .shared:
        return _d3d12.D3D12_MEMORY_POOL_L0
    case .dedicated:
        return _d3d12.D3D12_MEMORY_POOL_L1
        }
    }
}
