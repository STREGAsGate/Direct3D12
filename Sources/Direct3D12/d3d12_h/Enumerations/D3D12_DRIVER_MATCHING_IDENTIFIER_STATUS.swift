...
public enum DriverMatchingIdentifierStatus {
    ...
    internal var rawValue: _d3d12.D3D12_DRIVER_MATCHING_IDENTIFIER_STATUS {
        switch self {
        case .compatibleWithDevice:
            return _d3d12.D3D12_DRIVER_MATCHING_IDENTIFIER_COMPATIBLE_WITH_DEVICE
        case .unsupportedType:
            return _d3d12.D3D12_DRIVER_MATCHING_IDENTIFIER_UNSUPPORTED_TYPE
        case .unrecognized:
            return _d3d12.D3D12_DRIVER_MATCHING_IDENTIFIER_UNRECOGNIZED
        case .incompatibleVersion:
            return _d3d12.D3D12_DRIVER_MATCHING_IDENTIFIER_INCOMPATIBLE_VERSION
        case .incompatibleType:
            return _d3d12.D3D12_DRIVER_MATCHING_IDENTIFIER_INCOMPATIBLE_TYPE
        }
    }
}
