...
public struct ViewInstancingFlags: OptionSet {
    ...
    //static let none = ViewInstancingFlags(rawValue: _d3d12.D3D12_VIEW_INSTANCING_FLAG_NONE.rawValue)

    /// Enables view instance masking.
    static let enableViewInstanceMasking = ViewInstancingFlags(rawValue: _d3d12.D3D12_VIEW_INSTANCING_FLAG_ENABLE_VIEW_INSTANCE_MASKING.rawValue)
