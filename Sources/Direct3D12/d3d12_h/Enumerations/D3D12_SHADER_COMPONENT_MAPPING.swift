...
case forceOne
    ...
    internal var rawValue: _d3d12.D3D12_SHADER_COMPONENT_MAPPING {
        switch self {
        case .red:
            return _d3d12.D3D12_SHADER_COMPONENT_MAPPING_FROM_MEMORY_COMPONENT_0
        case .green:
            return _d3d12.D3D12_SHADER_COMPONENT_MAPPING_FROM_MEMORY_COMPONENT_1
        case .blue:
            return _d3d12.D3D12_SHADER_COMPONENT_MAPPING_FROM_MEMORY_COMPONENT_2
        case .alpha:
            return _d3d12.D3D12_SHADER_COMPONENT_MAPPING_FROM_MEMORY_COMPONENT_3
        case .forceZero:
            return _d3d12.D3D12_SHADER_COMPONENT_MAPPING_FORCE_VALUE_0
        case .forceOne:
            return _d3d12.D3D12_SHADER_COMPONENT_MAPPING_FORCE_VALUE_1
        }
    }
}
