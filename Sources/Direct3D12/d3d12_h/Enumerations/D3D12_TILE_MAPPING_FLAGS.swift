...
public struct TileMappingFlags: OptionSet {
    ...
    //static let none = TileMappingFlags(rawValue: _d3d12.D3D12_TILE_MAPPING_FLAG_NONE.rawValue)

    /// Unsupported, do not use.
    @available(*, deprecated, message: "Unsupported, do not use.")
    static let noHazard = TileMappingFlags(rawValue: _d3d12.D3D12_TILE_MAPPING_FLAG_NO_HAZARD.rawValue)
