...
public struct TileRangeFlags: OptionSet {
    ...
    //static let none = TileRangeFlags(rawValue: _d3d12.D3D12_TILE_RANGE_FLAG_NONE.rawValue)

    ///	The tile range is NULL.
    static let null = TileRangeFlags(rawValue: _d3d12.D3D12_TILE_RANGE_FLAG_NULL.rawValue)
    ///	Skip the tile range.
    static let skip = TileRangeFlags(rawValue: _d3d12.D3D12_TILE_RANGE_FLAG_SKIP.rawValue)
    ///	Reuse a single tile in the tile range.
    static let reuseSingleTile = TileRangeFlags(rawValue: _d3d12.D3D12_TILE_RANGE_FLAG_REUSE_SINGLE_TILE.rawValue)
