...
public enum ResourceBarrierType {
    ...
    internal var rawValue: _d3d12.D3D12_RESOURCE_BARRIER_TYPE {
        switch self {
        case .transition:
            return _d3d12.D3D12_RESOURCE_BARRIER_TYPE_TRANSITION
        case .aliasing:
            return _d3d12.D3D12_RESOURCE_BARRIER_TYPE_ALIASING
        case .unorderedAccessView:
            return _d3d12.D3D12_RESOURCE_BARRIER_TYPE_UAV
        }
    }
}
