...
public enum DebugDeviceParameterType {
    ...
    internal var rawValue: _d3d12.D3D12_DEBUG_DEVICE_PARAMETER_TYPE {
        switch self {
    case .featureFlags:
        return _d3d12.D3D12_DEBUG_DEVICE_PARAMETER_FEATURE_FLAGS
    case .gpuBasedValidationSettings:
        return _d3d12.D3D12_DEBUG_DEVICE_PARAMETER_GPU_BASED_VALIDATION_SETTINGS
    case .gpuSlowdownPerformanceFactor:
        return _d3d12.D3D12_DEBUG_DEVICE_PARAMETER_GPU_SLOWDOWN_PERFORMANCE_FACTOR
        }
    }
}
