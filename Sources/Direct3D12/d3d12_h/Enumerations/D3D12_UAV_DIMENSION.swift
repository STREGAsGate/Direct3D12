...
public enum UnorderedAccesssViewDimension {
    ...
    internal var rawValue: _d3d12.D3D12_UAV_DIMENSION {
        switch self {
        case .unknown:
            return _d3d12.D3D12_UAV_DIMENSION_UNKNOWN
        case .buffer:
            return _d3d12.D3D12_UAV_DIMENSION_BUFFER
        case .texture1D:
            return _d3d12.D3D12_UAV_DIMENSION_TEXTURE1D
        case .texture1dArray:
            return _d3d12.D3D12_UAV_DIMENSION_TEXTURE1DARRAY
        case .texture2D:
            return _d3d12.D3D12_UAV_DIMENSION_TEXTURE2D
        case .texture2dArray:
            return _d3d12.D3D12_UAV_DIMENSION_TEXTURE2DARRAY
        case .texture3D:
            return _d3d12.D3D12_UAV_DIMENSION_TEXTURE3D
        }
    }
}
