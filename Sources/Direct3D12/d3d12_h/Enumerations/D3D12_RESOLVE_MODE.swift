...
public enum ResolveMode {
    ...
    internal var rawValue: _d3d12.D3D12_RESOLVE_MODE {
        switch self {
        case .decompress:
            return _d3d12.D3D12_RESOLVE_MODE_DECOMPRESS
        case .min:
            return _d3d12.D3D12_RESOLVE_MODE_MIN
        case .max:
            return _d3d12.D3D12_RESOLVE_MODE_MAX
        case .average:
            return _d3d12.D3D12_RESOLVE_MODE_AVERAGE
        case .encodeSamplerFeedback:
            return _d3d12.D3D12_RESOLVE_MODE_ENCODE_SAMPLER_FEEDBACK
        case .decodeSamplerFeedback:
            return _d3d12.D3D12_RESOLVE_MODE_DECODE_SAMPLER_FEEDBACK
        }
    }
}
