...
public enum RenderPassEndingAccessType {
    ...
    internal var rawValue: _d3d12.D3D12_RENDER_PASS_ENDING_ACCESS_TYPE {
        switch self {
        case .discard:
            return _d3d12.D3D12_RENDER_PASS_ENDING_ACCESS_TYPE_DISCARD
        case .preserve:
            return _d3d12.D3D12_RENDER_PASS_ENDING_ACCESS_TYPE_PRESERVE
        case .resolve:
            return _d3d12.D3D12_RENDER_PASS_ENDING_ACCESS_TYPE_RESOLVE
        case .noAccess:
            return _d3d12.D3D12_RENDER_PASS_ENDING_ACCESS_TYPE_NO_ACCESS
        }
    }
}
