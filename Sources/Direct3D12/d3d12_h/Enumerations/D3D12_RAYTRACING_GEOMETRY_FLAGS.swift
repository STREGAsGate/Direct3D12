...
public struct RaytracingGeometryFlags: OptionSet {
    ...
    //static let none = RaytracingGeometryFlags(rawValue: _d3d12.D3D12_RAYTRACING_GEOMETRY_FLAG_NONE.rawValue)
    ...
    static let opaque = RaytracingGeometryFlags(rawValue: _d3d12.D3D12_RAYTRACING_GEOMETRY_FLAG_OPAQUE.rawValue)
    ...
    static let noDuplicateAnyHitInvocation = RaytracingGeometryFlags(rawValue: _d3d12.D3D12_RAYTRACING_GEOMETRY_FLAG_NO_DUPLICATE_ANYHIT_INVOCATION.rawValue)
