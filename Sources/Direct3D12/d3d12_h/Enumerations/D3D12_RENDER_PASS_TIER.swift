...
public enum RenderPassTier {
    ...
    internal var rawValue: _d3d12.D3D12_RENDER_PASS_TIER {
        switch self {
        case .tier0:
            return _d3d12.D3D12_RENDER_PASS_TIER_0
        case .tier1:
            return _d3d12.D3D12_RENDER_PASS_TIER_1
        case .tier2:
            return _d3d12.D3D12_RENDER_PASS_TIER_2
        }
    }
}
