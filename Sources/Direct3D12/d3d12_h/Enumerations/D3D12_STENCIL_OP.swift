...
public enum StencilOperations {
    ...
    internal var rawValue: _d3d12.D3D12_STENCIL_OP {
        switch self {
        case .keep:
            return _d3d12.D3D12_STENCIL_OP_KEEP
        case .zero:
            return _d3d12.D3D12_STENCIL_OP_ZERO
        case .replace:
            return _d3d12.D3D12_STENCIL_OP_REPLACE
        case .incrementClamp:
            return _d3d12.D3D12_STENCIL_OP_INCR_SAT
        case .decrementClamp:
            return _d3d12.D3D12_STENCIL_OP_DECR_SAT
        case .invert:
            return _d3d12.D3D12_STENCIL_OP_INVERT
        case .incrementWrap:
            return _d3d12.D3D12_STENCIL_OP_INCR
        case .decrementWrap:
            return _d3d12.D3D12_STENCIL_OP_DECR
        }
    }
}
