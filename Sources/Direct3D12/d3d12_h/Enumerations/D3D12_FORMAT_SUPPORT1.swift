...
public struct FormatSupport1: OptionSet {
    ...
    //static let none = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_NONE.rawValue)

    ///	Buffer resources supported.
    static let buffer = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_BUFFER.rawValue)
    ///	Vertex buffers supported.
    static let iaVertexBuffer = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_IA_VERTEX_BUFFER.rawValue)
    ///	Index buffers supported.
    static let iaIndexBuffer = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_IA_INDEX_BUFFER.rawValue)
    ///	Streaming output buffers supported.
    static let streamingOutputBuffer = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_SO_BUFFER.rawValue)
    ///	1D texture resources supported.
    static let texture1D = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_TEXTURE1D.rawValue)
    ///	2D texture resources supported.
    static let texture2D = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_TEXTURE2D.rawValue)
    ///	3D texture resources supported.
    static let texture3D = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_TEXTURE3D.rawValue)
    ///	Cube texture resources supported.
    static let textureCube = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_TEXTURECUBE.rawValue)
    ///	The HLSL Load function for texture objects is supported.
    static let shaderLoad = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_SHADER_LOAD.rawValue)	
    ...
    */
    static let shaderSample = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_SHADER_SAMPLE.rawValue) 
    ///	Reserved.
    static let shaderSampleMonoText = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_SHADER_SAMPLE_MONO_TEXT.rawValue)
    ///	Mipmaps are supported.
    static let mip = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_MIP.rawValue)
    ///	Render targets are supported.
    static let renderTarget = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_RENDER_TARGET.rawValue)
    ///	Blend operations supported.
    static let blendable = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_BLENDABLE.rawValue)
    ///	Depth stencils supported.
    static let depthStencil = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_DEPTH_STENCIL.rawValue)
    ...
    static let multisampleResolve = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_MULTISAMPLE_RESOLVE.rawValue)
    ///	Format can be displayed on screen.
    static let display = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_DISPLAY.rawValue)
    ///	Format can't be cast to another format.
    static let castWithinBitLayout = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_CAST_WITHIN_BIT_LAYOUT.rawValue)
    ///	Format can be used as a multi-sampled render target.
    static let multisampleRendertarget = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_MULTISAMPLE_RENDERTARGET.rawValue)
    ///	Format can be used as a multi-sampled texture and read into a shader with the HLSL Load function.
    static let multisampleLoad = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_MULTISAMPLE_LOAD.rawValue)
    ///	Format can be used with the HLSL gather function. This value is available in DirectX 10.1 or higher.
    static let shaderGather = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_SHADER_GATHER.rawValue)
    ///	Format supports casting when the resource is a back buffer.
    static let backBufferCast = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_BACK_BUFFER_CAST.rawValue)
    ///	Format can be used for an unordered access view.
    static let typedUnorderedAccessView = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_TYPED_UNORDERED_ACCESS_VIEW.rawValue)
    ///	Format can be used with the HLSL gather with comparison function.
    static let shaderGatherComparison = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_SHADER_GATHER_COMPARISON.rawValue)
    ///	Format can be used with the decoder output.
    static let decoderOutput = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_DECODER_OUTPUT.rawValue)
    ///	Format can be used with the video processor output.
    static let videoProcessorOutput = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_VIDEO_PROCESSOR_OUTPUT.rawValue)
    ///	Format can be used with the video processor input.
    static let videoProcessorInput = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_VIDEO_PROCESSOR_INPUT.rawValue)
    ///	Format can be used with the video encoder.
    static let videoEncoder = FormatSupport1(rawValue: _d3d12.D3D12_FORMAT_SUPPORT1_VIDEO_ENCODER.rawValue)
