...
public struct ProtectedResourceSessionSupportFlags: OptionSet {
    ...
    //static let none = ProtectedResourceSessionSupportFlags(rawValue: _d3d12.D3D12_PROTECTED_RESOURCE_SESSION_SUPPORT_FLAG_NONE.rawValue)

    /// Indicates that protected resource sessions are supported.
    static let supported = ProtectedResourceSessionSupportFlags(rawValue: _d3d12.D3D12_PROTECTED_RESOURCE_SESSION_SUPPORT_FLAG_SUPPORTED.rawValue)
