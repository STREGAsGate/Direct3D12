...
public enum ResourceBindingTier {
    ...
    internal var rawValue: _d3d12.D3D12_RESOURCE_BINDING_TIER {
        switch self {
        case .tier1:
            return _d3d12.D3D12_RESOURCE_BINDING_TIER_1
        case .tier2:
            return _d3d12.D3D12_RESOURCE_BINDING_TIER_2
        case .tier3:
            return _d3d12.D3D12_RESOURCE_BINDING_TIER_3
        }
    }
}
