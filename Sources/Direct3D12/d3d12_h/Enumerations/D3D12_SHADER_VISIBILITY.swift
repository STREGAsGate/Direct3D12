...
public enum ShaderVisibility {
    ...
    internal var rawValue: _d3d12.D3D12_SHADER_VISIBILITY {
        switch self {
    case .all:
        return _d3d12.D3D12_SHADER_VISIBILITY_ALL
    case .vertex:
        return _d3d12.D3D12_SHADER_VISIBILITY_VERTEX
    case .hull:
        return _d3d12.D3D12_SHADER_VISIBILITY_HULL
    case .domain:
        return _d3d12.D3D12_SHADER_VISIBILITY_DOMAIN
    case .geometry:
        return _d3d12.D3D12_SHADER_VISIBILITY_GEOMETRY
    case .pixel:
        return _d3d12.D3D12_SHADER_VISIBILITY_PIXEL
    case .amplification:
        return _d3d12.D3D12_SHADER_VISIBILITY_AMPLIFICATION
    case .mesh:
        return _d3d12.D3D12_SHADER_VISIBILITY_MESH
        }
    }
}
