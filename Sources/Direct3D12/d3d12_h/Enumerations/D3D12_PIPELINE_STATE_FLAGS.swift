...
public struct PipelineStateFlags: OptionSet {
    ...
    ///// Indicates no flags.
    //static let none = PipelineStateFlags(rawValue: _d3d12.D3D12_PIPELINE_STATE_FLAG_NONE.rawValue)
    ...
    static let toolDebug = PipelineStateFlags(rawValue: _d3d12.D3D12_PIPELINE_STATE_FLAG_TOOL_DEBUG.rawValue)
