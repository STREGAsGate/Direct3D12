...
public enum DredAllocationType {
    ...
    internal var rawValue: _d3d12.D3D12_DRED_ALLOCATION_TYPE {
        switch self {
        case .commandQueue:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_COMMAND_QUEUE
        case .commandAllocator:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_COMMAND_ALLOCATOR
        case .pipelineState:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_PIPELINE_STATE
        case .commandList:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_COMMAND_LIST
        case .fence:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_FENCE
        case .descriptorHeap:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_DESCRIPTOR_HEAP
        case .heap:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_HEAP
        case .queryHeap:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_QUERY_HEAP
        case .commandSignature:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_COMMAND_SIGNATURE
        case .pipelineLibrary:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_PIPELINE_LIBRARY
        case .videoDecoder:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_VIDEO_DECODER
        case .videoProcessor:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_VIDEO_PROCESSOR
        case .resource:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_RESOURCE
        case .pass:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_PASS
        case .cryptoSession:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_CRYPTOSESSION
        case .cryptoSessionPolicy:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_CRYPTOSESSIONPOLICY
        case .portectedResourceSession:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_PROTECTEDRESOURCESESSION
        case .videoDecoderHeap:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_VIDEO_DECODER_HEAP
        case .commandPool:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_COMMAND_POOL
        case .commandRecorder:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_COMMAND_RECORDER
        case .stateObeject:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_STATE_OBJECT
        case .metaCommand:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_METACOMMAND
        case .schedulingGroup:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_SCHEDULINGGROUP
        case .videoMotionEstimator:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_VIDEO_MOTION_ESTIMATOR
        case .motionVectorHeap:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_VIDEO_MOTION_VECTOR_HEAP
        case .videoExtensionCommand:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_VIDEO_EXTENSION_COMMAND
        case .invalid:
            return _d3d12.D3D12_DRED_ALLOCATION_TYPE_INVALID
        }
    }
}
