...
public struct CommandListSupportFlags: OptionSet {
    ...
    //static let none = CommandListSupportFlags(rawValue: _d3d12.D3D12_COMMAND_LIST_SUPPORT_FLAG_NONE.rawValue)

    /// Specifies that direct command lists can support the operation in question.
    static let direct = CommandListSupportFlags(rawValue: _d3d12.D3D12_COMMAND_LIST_SUPPORT_FLAG_DIRECT.rawValue)

    /// Specifies that command list bundles can support the operation in question.
    static let bundle = CommandListSupportFlags(rawValue: _d3d12.D3D12_COMMAND_LIST_SUPPORT_FLAG_BUNDLE.rawValue)

    /// Specifies that compute command lists can support the operation in question.
    static let compute = CommandListSupportFlags(rawValue: _d3d12.D3D12_COMMAND_LIST_SUPPORT_FLAG_COMPUTE.rawValue)

    /// Specifies that copy command lists can support the operation in question.
    static let copy = CommandListSupportFlags(rawValue: _d3d12.D3D12_COMMAND_LIST_SUPPORT_FLAG_COPY.rawValue)

    /// Specifies that video-decode command lists can support the operation in question.
    static let videoDecode = CommandListSupportFlags(rawValue: _d3d12.D3D12_COMMAND_LIST_SUPPORT_FLAG_VIDEO_DECODE.rawValue)

    /// Specifies that video-processing command lists can support the operation is question.
    static let videoProcess = CommandListSupportFlags(rawValue: _d3d12.D3D12_COMMAND_LIST_SUPPORT_FLAG_VIDEO_PROCESS.rawValue)

    /// Specifies that video-encoding command lists can support the operation is question.
    static let videoEncode = CommandListSupportFlags(rawValue: _d3d12.D3D12_COMMAND_LIST_SUPPORT_FLAG_VIDEO_ENCODE.rawValue)
