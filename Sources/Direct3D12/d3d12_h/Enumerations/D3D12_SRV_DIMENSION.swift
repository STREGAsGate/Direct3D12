...
public enum ShaderResourceViewDimension {
    ...
    internal var rawValue: _d3d12.D3D12_SRV_DIMENSION {
        switch self {
        case .unknown:
            return _d3d12.D3D12_SRV_DIMENSION_UNKNOWN
        case .buffer:
            return _d3d12.D3D12_SRV_DIMENSION_BUFFER
        case .texture1D:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURE1D
        case .texture1dArray:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURE1DARRAY
        case .texture2D:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURE2D
        case .texture2dArray:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURE2DARRAY
        case .texture2dMultisampling:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURE2DMS
        case .texture2dArrayMultisampling:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURE2DMSARRAY
        case .texture3D:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURE3D
        case .textureCube:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURECUBE
        case .textureCubeArray:
            return _d3d12.D3D12_SRV_DIMENSION_TEXTURECUBEARRAY
        case .raytracingAccelerationStructure:
            return _d3d12.D3D12_SRV_DIMENSION_RAYTRACING_ACCELERATION_STRUCTURE
        }
    }
}
