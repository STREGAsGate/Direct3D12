...
public struct TileCopyFlags: OptionSet {
    ...
    //static let none = TileCopyFlags(rawValue: _d3d12.D3D12_TILE_COPY_FLAG_NONE.rawValue)

    ///	Indicates that the GPU isn't currently referencing any of the
    /// portions of destination memory being written.
    static let noHazard = TileCopyFlags(rawValue: _d3d12.D3D12_TILE_COPY_FLAG_NO_HAZARD.rawValue)
    ...
    static let linearBufferToSwizzledTiledResource = TileCopyFlags(rawValue: _d3d12.D3D12_TILE_COPY_FLAG_LINEAR_BUFFER_TO_SWIZZLED_TILED_RESOURCE.rawValue)
    ...
    static let swizzledTiledResourceToLinearBuffer = TileCopyFlags(rawValue: _d3d12.D3D12_TILE_COPY_FLAG_SWIZZLED_TILED_RESOURCE_TO_LINEAR_BUFFER.rawValue)
