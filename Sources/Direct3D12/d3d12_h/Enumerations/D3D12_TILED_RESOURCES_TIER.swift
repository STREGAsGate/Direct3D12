...
public enum TiledResourceTier {
    ...
    */
    ...
    internal var rawValue: _d3d12.D3D12_TILED_RESOURCES_TIER {
        switch self {
        case .notSupported:
            return _d3d12.D3D12_TILED_RESOURCES_TIER_NOT_SUPPORTED
        case .tier1:
            return _d3d12.D3D12_TILED_RESOURCES_TIER_1
        case .tier2:
            return _d3d12.D3D12_TILED_RESOURCES_TIER_2
        case .tier3:
            return _d3d12.D3D12_TILED_RESOURCES_TIER_3
        case .tier4:
            return _d3d12.D3D12_TILED_RESOURCES_TIER_4
        }
    }
}
