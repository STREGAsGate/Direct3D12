...
public enum RenderPassBeginningAccessType {
    ...
    internal var rawValue: _d3d12.D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE {
        switch self {
        case .discard:
            return _d3d12.D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_DISCARD
        case .preserve:
            return _d3d12.D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE
        case .clear:
            return _d3d12.D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_CLEAR
        case .noAccess:
            return _d3d12.D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_NO_ACCESS
        }
    }
}
