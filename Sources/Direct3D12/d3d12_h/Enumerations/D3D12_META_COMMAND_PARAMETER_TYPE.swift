...
public enum MetaCommandParameterType {
    ...
    internal var rawValue: _d3d12.D3D12_META_COMMAND_PARAMETER_TYPE {
        switch self {
        case .float:
            return _d3d12.D3D12_META_COMMAND_PARAMETER_TYPE_FLOAT
        case .uint64:
            return _d3d12.D3D12_META_COMMAND_PARAMETER_TYPE_UINT64
        case .gpuVirtualAddress:
            return _d3d12.D3D12_META_COMMAND_PARAMETER_TYPE_GPU_VIRTUAL_ADDRESS
        case .cpuDescriptoHeapHandle:
            return _d3d12.D3D12_META_COMMAND_PARAMETER_TYPE_CPU_DESCRIPTOR_HANDLE_HEAP_TYPE_CBV_SRV_UAV
        case .gpuDescriptorHeapHandle:
            return _d3d12.D3D12_META_COMMAND_PARAMETER_TYPE_GPU_DESCRIPTOR_HANDLE_HEAP_TYPE_CBV_SRV_UAV
        }
    }
}
