...
public struct MultipleFenceWaitFlags: OptionSet {
    ...
    ///// No flags.
    //static let none = MultipleFenceWaitFlags(rawValue: _d3d12.D3D12_MULTIPLE_FENCE_WAIT_FLAG_NONE.rawValue)
    ...
    static let any = MultipleFenceWaitFlags(rawValue: _d3d12.D3D12_MULTIPLE_FENCE_WAIT_FLAG_ANY.rawValue)

    /// An alias for D3D12_MULTIPLE_FENCE_WAIT_FLAG_NONE, meaning to use the default behavior and wait for all fences.    
    static let all = MultipleFenceWaitFlags(rawValue: _d3d12.D3D12_MULTIPLE_FENCE_WAIT_FLAG_ALL.rawValue)
