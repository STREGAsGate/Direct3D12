...
case suportedPlus
    ...
    internal var rawValue: _d3d12.D3D12_RAYTRACING_TIER {
        switch self {
        case .notSupported:
            return _d3d12.D3D12_RAYTRACING_TIER_NOT_SUPPORTED
        case .supported:
            return _d3d12.D3D12_RAYTRACING_TIER_1_0
        case .suportedPlus:
            return _d3d12.D3D12_RAYTRACING_TIER_1_1
        }
    }
}
