...
public struct ResourceStates: OptionSet {
    ...
    */
    static let common = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_COMMON.rawValue)
    ...
    static let vertexAndConstantBuffer = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER.rawValue)
    ///	A subresource must be in this state when it is accessed by the 3D pipeline as an index buffer. This is a read-only state.
    static let indexBuffer = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_INDEX_BUFFER.rawValue)
    ...
    static let rendertarget = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_RENDER_TARGET.rawValue)
    ...
    static let unorderedAccess = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_UNORDERED_ACCESS.rawValue)
    ...
    static let depthWrite = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_DEPTH_WRITE.rawValue)
    ...
    static let depthRead = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_DEPTH_READ.rawValue)
    ...
    static let nonPixelShaderResource = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE.rawValue)
    ...
    static let pixelShaderResource = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE.rawValue)
    ...
    static let streamOut = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_STREAM_OUT.rawValue)
    ...
    static let indirectArgument = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_INDIRECT_ARGUMENT.rawValue)
    ...
    static let copyDestination = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_COPY_DEST.rawValue)
    ...
    /// This is a read-only state.
    static let copySource = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_COPY_SOURCE.rawValue)
    ///	The resource is used as the destination in a resolve operation.
    static let resolveOperationDestination = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_RESOLVE_DEST.rawValue)
    ///	The resource is used as the source in a resolve operation.
    static let resolveOperationSource = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_RESOLVE_SOURCE.rawValue)
    ...
    static let raytracingAccelerationStructure = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_RAYTRACING_ACCELERATION_STRUCTURE.rawValue)
    ...
    static let shadingRateSource = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_SHADING_RATE_SOURCE.rawValue)
    ...
    static let genericRead = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_GENERIC_READ.rawValue)
    ///	Synonymous with D3D12_RESOURCE_STATE_COMMON.
    static let present = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_PRESENT.rawValue)
    ///	The resource is used for Predication.
    static let predication = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_PREDICATION.rawValue)
    ...
    static let videoDecodeRead = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_VIDEO_DECODE_READ.rawValue)
    ///	The resource is used as a destination in the decode operation. This state is used for decode output and histograms.
    static let videoDecodeWrite = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_VIDEO_DECODE_WRITE.rawValue)
    ...
    static let videoProcessRead = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_VIDEO_PROCESS_READ.rawValue)
    ...
    static let videoProcessWrite = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_VIDEO_PROCESS_WRITE.rawValue)
    ...
    static let videoEncodeRead = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_VIDEO_ENCODE_READ.rawValue)
    ...
    static let videoEncodeWrite = ResourceStates(rawValue: _d3d12.D3D12_RESOURCE_STATE_VIDEO_ENCODE_WRITE.rawValue)
