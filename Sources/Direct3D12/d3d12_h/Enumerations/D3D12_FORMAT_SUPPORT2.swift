...
public struct FormatSupport2: OptionSet {
    ...
    //static let none = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_NONE.rawValue)

    ///	Format supports atomic add.
    static let uavAtomicAdd = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_ADD.rawValue)
    ///	Format supports atomic bitwise operations.
    static let uavAtomicBitwiseOperations = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_BITWISE_OPS.rawValue)
    ///	Format supports atomic compare with store or exchange.
    static let uavAtomicComparerStoreOrCompareExchange = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_COMPARE_STORE_OR_COMPARE_EXCHANGE.rawValue)
    ///	Format supports atomic exchange.
    static let uavAtomicExchange = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_EXCHANGE.rawValue)
    ///	Format supports atomic min and max.
    static let uavAtomicSignedMinOrMax = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_SIGNED_MIN_OR_MAX.rawValue)
    ///	Format supports atomic unsigned min and max.
    static let uavAtomicUnsignedMinOrMax = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_UAV_ATOMIC_UNSIGNED_MIN_OR_MAX.rawValue)
    ///	Format supports a typed load.
    static let uavTypedLoad = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_UAV_TYPED_LOAD.rawValue)
    ///	Format supports a typed store.
    static let uavTypedStore = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_UAV_TYPED_STORE.rawValue)
    ///	Format supports logic operations in blend state.
    static let outputMergerLogicOperation = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_OUTPUT_MERGER_LOGIC_OP.rawValue)
    ///	Format supports tiled resources. Refer to Volume Tiled Resources.
    static let tiled = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_TILED.rawValue)
    ///	Format supports multi-plane overlays.
    static let multiplaneOverlay = FormatSupport2(rawValue: _d3d12.D3D12_FORMAT_SUPPORT2_MULTIPLANE_OVERLAY.rawValue)
