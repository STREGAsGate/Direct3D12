...
public struct ResourceFlags: OptionSet {
    ...
    //static let none = ResourceFlags(rawValue: _d3d12.D3D12_RESOURCE_FLAG_NONE.rawValue)
    ...
    */
    static let allowRenderTarget = ResourceFlags(rawValue: _d3d12.D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET.rawValue)
    /**
    ...
    */
    static let allowDepthStencil = ResourceFlags(rawValue: _d3d12.D3D12_RESOURCE_FLAG_ALLOW_DEPTH_STENCIL.rawValue)
    /**
    ...
    */
    static let allowUnorderedAccess = ResourceFlags(rawValue: _d3d12.D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS.rawValue)
    /**
    ...
    */
    static let denyShaderResource = ResourceFlags(rawValue: _d3d12.D3D12_RESOURCE_FLAG_DENY_SHADER_RESOURCE.rawValue)
    /**
    ...
    */
    static let allowCrossAdapter = ResourceFlags(rawValue: _d3d12.D3D12_RESOURCE_FLAG_ALLOW_CROSS_ADAPTER.rawValue)
    /**
    ...
    */
    static let allowSimultaneousAccess = ResourceFlags(rawValue: _d3d12.D3D12_RESOURCE_FLAG_ALLOW_SIMULTANEOUS_ACCESS.rawValue)
    /**
    ...
    */
    static let videoDecodeReferenceOnly = ResourceFlags(rawValue: _d3d12.D3D12_RESOURCE_FLAG_VIDEO_DECODE_REFERENCE_ONLY.rawValue)
