...
public struct StateObjectFlags: OptionSet {
    ...
    //static let none = StateObjectFlags(rawValue: _d3d12.D3D12_STATE_OBJECT_FLAG_NONE.rawValue)
    ...
    */
    static let allowLocalDependenciesOnExternalDefinitions = StateObjectFlags(rawValue: _d3d12.D3D12_STATE_OBJECT_FLAG_ALLOW_LOCAL_DEPENDENCIES_ON_EXTERNAL_DEFINITIONS.rawValue)
    /**
    This flag applies to state objects of type collection only. Otherwise this flag is ignored.
    ...
    */
    static let allowExternalDependenciesOnLocalDefinitions = StateObjectFlags(rawValue: _d3d12.D3D12_STATE_OBJECT_FLAG_ALLOW_EXTERNAL_DEPENDENCIES_ON_LOCAL_DEFINITIONS.rawValue)
