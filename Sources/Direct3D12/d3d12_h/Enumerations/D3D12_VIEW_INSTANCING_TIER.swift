...
case tier3
    ...
    internal var rawValue: _d3d12.D3D12_VIEW_INSTANCING_TIER {
        switch self {
        case .notSupported:
            return _d3d12.D3D12_VIEW_INSTANCING_TIER_NOT_SUPPORTED
        case .tier1:
            return _d3d12.D3D12_VIEW_INSTANCING_TIER_1
        case .tier2:
            return _d3d12.D3D12_VIEW_INSTANCING_TIER_2
        case .tier3:
            return _d3d12.D3D12_VIEW_INSTANCING_TIER_3
        }
    }
}
