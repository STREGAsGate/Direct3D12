...
case execution
    ...
    internal var rawValue: _d3d12.D3D12_META_COMMAND_PARAMETER_STAGE {
        switch self {
        case .creation:
            return _d3d12.D3D12_META_COMMAND_PARAMETER_STAGE_CREATION
        case .initialization:
            return _d3d12.D3D12_META_COMMAND_PARAMETER_STAGE_INITIALIZATION
        case .execution:
            return _d3d12.D3D12_META_COMMAND_PARAMETER_STAGE_EXECUTION
        }
    }
}
