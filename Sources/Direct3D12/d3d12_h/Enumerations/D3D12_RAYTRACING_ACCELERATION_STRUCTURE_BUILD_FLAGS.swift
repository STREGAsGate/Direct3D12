...
public struct RaytracingAccelerationStructureBuildFalgs: OptionSet {
    ...
    //static let none = RaytracingAccelerationStructureBuildFalgs(rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_NONE.rawValue)
    ...
    */
    static let allowUpdates = RaytracingAccelerationStructureBuildFalgs(rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_ALLOW_UPDATE.rawValue)
    /**
    ...
    */
    static let allowCompaction = RaytracingAccelerationStructureBuildFalgs(rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_ALLOW_COMPACTION.rawValue)
    /**
    ...
    */
    static let preferFastTrace = RaytracingAccelerationStructureBuildFalgs(rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_PREFER_FAST_TRACE.rawValue)
    /**
    ...
    */
    static let preferFastBuild = RaytracingAccelerationStructureBuildFalgs(rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_PREFER_FAST_BUILD.rawValue)
    /**
    ...
    */
    static let minimizeMemory = RaytracingAccelerationStructureBuildFalgs(rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_MINIMIZE_MEMORY.rawValue)
    /**
    ...
    */
    static let performUpdate = RaytracingAccelerationStructureBuildFalgs(rawValue: _d3d12.D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_PERFORM_UPDATE.rawValue)
