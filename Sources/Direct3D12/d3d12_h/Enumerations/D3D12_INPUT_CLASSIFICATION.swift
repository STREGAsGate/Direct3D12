...
public enum InputClassification {
    ...
    internal var rawValue: _d3d12.D3D12_INPUT_CLASSIFICATION {
        switch self {
        case .perVertexData:
            return _d3d12.D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA
        case .perInstanceData:
            return _d3d12.D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA
        }
    }
}
