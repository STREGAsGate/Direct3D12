...
public struct RayFlags: OptionSet {
    ...
    ///// No options selected.
    //static let none = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_NONE.rawValue)
    ...
    static let forceOpaque = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_FORCE_OPAQUE.rawValue)
    ...
    static let forceNonOpaque = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_FORCE_NON_OPAQUE.rawValue)
    ...
    static let acceptFirstHitAndEndSearch = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_ACCEPT_FIRST_HIT_AND_END_SEARCH.rawValue)
    ...
    static let skipClosestHitShader = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_SKIP_CLOSEST_HIT_SHADER.rawValue)
    ...
    static let cullBackFacingTriangles = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_CULL_BACK_FACING_TRIANGLES.rawValue)
    ...
    ///
    /// This flag is mutually exclusive with RAY_FLAG_CULL_FRONT_FACING_TRIANGLES.
    static let cullFrontFacingTriangles = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_CULL_FRONT_FACING_TRIANGLES.rawValue)
    ...
    static let cullOpaque = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_CULL_OPAQUE.rawValue)
    ...
    static let cullNonOpaque = RayFlags(rawValue: _d3d12.D3D12_RAY_FLAG_CULL_NON_OPAQUE.rawValue)
