...
public struct DebugFeature: OptionSet {
    ...
    //static let none = DebugFeature(rawValue: _d3d12.D3D12_DEBUG_FEATURE_NONE.rawValue)
    ...
    static let allowBehaviorChangingDebugAids = DebugFeature(rawValue: _d3d12.D3D12_DEBUG_FEATURE_ALLOW_BEHAVIOR_CHANGING_DEBUG_AIDS.rawValue) 
    ...
    static let conservativeResourceStateTracking = DebugFeature(rawValue: _d3d12.D3D12_DEBUG_FEATURE_CONSERVATIVE_RESOURCE_STATE_TRACKING.rawValue) 
    ///	Disables validation of bundle commands by virtually injecting checks into the calling command list validation paths.
    static let disablesVirtualizedBundlesValidation = DebugFeature(rawValue: _d3d12.D3D12_DEBUG_FEATURE_DISABLE_VIRTUALIZED_BUNDLES_VALIDATION.rawValue) 
