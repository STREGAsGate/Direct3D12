...
public struct RenderPassFlags: OptionSet {
    ...
    //static let none = RenderPassFlags(rawValue: _d3d12.D3D12_RENDER_PASS_FLAG_NONE.rawValue)

    ///	Indicates that writes to unordered access view(s) should be allowed during the render pass.
    static let allowUnorderedAccessViewWrites = RenderPassFlags(rawValue: _d3d12.D3D12_RENDER_PASS_FLAG_ALLOW_UAV_WRITES.rawValue)
    ///	Indicates that this is a suspending render pass.
    static let suspendingPass = RenderPassFlags(rawValue: _d3d12.D3D12_RENDER_PASS_FLAG_SUSPENDING_PASS.rawValue)
    ///	Indicates that this is a resuming render pass.
    static let resumingPass = RenderPassFlags(rawValue: _d3d12.D3D12_RENDER_PASS_FLAG_RESUMING_PASS.rawValue)
