...
public enum ResourceDimension {
    ...
    internal var rawValue: _d3d12.D3D12_RESOURCE_DIMENSION {
        switch self {
        case .unknown:
            return _d3d12.D3D12_RESOURCE_DIMENSION_UNKNOWN
        case .buffer:
            return _d3d12.D3D12_RESOURCE_DIMENSION_BUFFER
        case .texture1D:
            return _d3d12.D3D12_RESOURCE_DIMENSION_TEXTURE1D
        case .texture2D:
            return _d3d12.D3D12_RESOURCE_DIMENSION_TEXTURE2D
        case .texture3D:
            return _d3d12.D3D12_RESOURCE_DIMENSION_TEXTURE3D
        }
    }
}
