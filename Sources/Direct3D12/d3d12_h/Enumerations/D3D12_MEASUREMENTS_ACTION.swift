...
public enum MeasurmentAction {
    ...
    internal var rawValue: _d3d12.D3D12_MEASUREMENTS_ACTION {
        switch self {
        case .keepAll:
            return _d3d12.D3D12_MEASUREMENTS_ACTION_KEEP_ALL
        case .commitResults:
            return _d3d12.D3D12_MEASUREMENTS_ACTION_COMMIT_RESULTS
        case .commitResultsHighPriority:
            return _d3d12.D3D12_MEASUREMENTS_ACTION_COMMIT_RESULTS_HIGH_PRIORITY
        case .discardPrevious:
            return _d3d12.D3D12_MEASUREMENTS_ACTION_DISCARD_PREVIOUS
        }
    }
}
