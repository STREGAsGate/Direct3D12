...
public enum TextureAddressMode {
    ...
    internal var rawValue: _d3d12.D3D12_TEXTURE_ADDRESS_MODE {
        switch self {
        case .wrap:
            return _d3d12.D3D12_TEXTURE_ADDRESS_MODE_WRAP
        case .mirror:
            return _d3d12.D3D12_TEXTURE_ADDRESS_MODE_MIRROR
        case .clamp:
            return _d3d12.D3D12_TEXTURE_ADDRESS_MODE_CLAMP
        case .border:
            return _d3d12.D3D12_TEXTURE_ADDRESS_MODE_BORDER
        case .mirrorOnce:
            return _d3d12.D3D12_TEXTURE_ADDRESS_MODE_MIRROR_ONCE
        }
    }
}
